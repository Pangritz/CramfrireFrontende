...
<div :class="{ 'only-on-print': props.only_on_print }">
    ...
    <div class="print-test" 
        :class="{'with-solution': props.with_solution}">
        <div class="print-test-row" v-for="card in props.cards" :key="card.id">
            <div class="print-test-question-column px-2 py-6">
            ...
            <div class="print-test-answer-column px-2 py-6"></div>

            <div class="print-test-solution-column px-2 py-6">
...
.print-test-question-column , .print-test-answer-column, .print-test-solution-column { 
    float: left;
    width: 50%; 
}

.print-test-answer-column { border-left: 1px solid #000; }

.print-test-solution-column {
    display: none; 
    border-left: 2px dashed #000;
    width: 33.333%;
}

.print-test.with-solution .print-test-solution-column { display: block; }

.print-test.with-solution .print-test-question-column,
.print-test.with-solution .print-test-answer-column {
    width: 33.333%;
}
